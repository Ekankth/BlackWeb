...
async def upstream(client: Client, message: Message):
    ...
    if HEROKU_API_KEY is not None:
        ...
        if heroku_app is None:
            ...
            return
        await status.edit(
            "`[HEROKU]: BlackWeb Deploy Update is in Progress...`"
        )
        ups_rem.fetch(ac_br)
        ...
        try:
            ...
            pass
        await status.edit(
            "`BlackWeb Successfully Updated! BlackWeb can be used again.`"
        )
    else:
        try:
            ups_rem.pull(ac_br)
        ...
        await status.edit(
            "`BlackWeb Successfully Updated! KillerXBase can be used again.`",
        )
...
add_command_help(
    "updater",
    [
        ["update", "To see a list of the latest updates from BlackWeb."],
        ["update deploy", "To update BlackWeb."],
    ],
)
